export const TAILWIND_PALETTE_STEPS = [
  "50",
  "100",
  "200",
  "300",
...
export type TailwindPaletteStep = (typeof TAILWIND_PALETTE_STEPS)[number];
...
const COMPACT_SWATCH_PALETTES = [
  ...
  "pink",
  "rose",
] as const satisfies readonly TailwindPaletteName[];

export const TAILWIND_COMPACT_COLOR_SWATCHES = [
  ...COMPACT_SWATCH_PALETTES.map((name) => TAILWIND_COLOR_PALETTES[name]["500"]),
  TAILWIND_COLOR_PALETTES.slate["50"],
  TAILWIND_COLOR_PALETTES.slate["950"],
  TAILWIND_COLOR_PALETTES.neutral["50"],
    ...
    TAILWIND_PALETTE_NAMES.map((name) => [
      ...
      Object.fromEntries(
        TAILWIND_PALETTE_STEPS.map((step) => [
          step,
          { $type: "color" as const, $value: TAILWIND_COLOR_PALETTES[name][step] },
        ]),
      ),
    ]),
  ) as Record<TailwindPaletteName, ColorTokenGroup>;
}
