export { ClockWidget, ClockWidgetSettings, type ClockConfig } from './ClockWidget';
export { CalendarWidget, CalendarWidgetSettings, type CalendarConfig } from './CalendarWidget';
export { GoogleCalendarWidget, GoogleCalendarWidgetSettings, type GoogleCalendarConfig } from './GoogleCalendarWidget';
export { PhotoWidget, PhotoWidgetSettings, type PhotoConfig } from './PhotoWidget';
