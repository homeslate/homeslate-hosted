...
import type { TimerAlertPayload } from './alert';
import {
...
type EnqueueFn = (item: TimerAlertPayload) => void;
...
interface TimersContextValue {
  ...
  restartFromAlert: (timer: TimerAlertPayload['timer']) => void;
}
